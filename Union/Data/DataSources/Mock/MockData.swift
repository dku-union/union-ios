...
enum MockData {
    ...
    static let categories: [AppCategory] = [
        AppCategory(id: 1, name: "축제", emoji: "🎪", colorHex: "FF6060", iconUrl: nil),
        AppCategory(id: 2, name: "학식", emoji: "🍚", colorHex: "FFB547", iconUrl: nil),
        AppCategory(id: 3, name: "스터디", emoji: "📚", colorHex: "3B5BFF", iconUrl: nil),
        AppCategory(id: 4, name: "거래", emoji: "🛍️", colorHex: "22C993", iconUrl: nil),
        AppCategory(id: 5, name: "소통", emoji: "💬", colorHex: "8B5CF6", iconUrl: nil),
        AppCategory(id: 6, name: "기타", emoji: "📦", colorHex: "FF9A5C", iconUrl: nil),
    ]
    ...
    static let allApps: [MiniApp] = [
        MiniApp(id: 14,
                name: "택시팟", description: "단국대 택시 합승 매칭 플랫폼",
                publisher: "Union Dev", category: "ETC",
        ...
        MiniApp(id: 2,
                ...
                publisher: "Union Dev", category: "FESTIVAL",
                iconUrl: nil, iconEmoji: "🚀", iconColorHex: "3B5BFF",
                rating: 5.0, ratingCount: 1,
                isNew: true, isPopular: true, createdAt: date(daysAgo: 0),
        ...
        MiniApp(id: 3,
                ...
                publisher: "총학생회", category: "FESTIVAL",
                iconUrl: nil, iconEmoji: "🍻", iconColorHex: "FFB547",
        ...
        MiniApp(id: 4,
                ...
                publisher: "dev.김민수", category: "STUDY",
                iconUrl: nil, iconEmoji: "📖", iconColorHex: "3B5BFF",
        ...
        MiniApp(id: 5,
                ...
                publisher: "dev.이서연", category: "MEAL",
                iconUrl: nil, iconEmoji: "🍱", iconColorHex: "FF9A5C",
                rating: 4.6, ratingCount: 278,
                isNew: false, isPopular: true, createdAt: date(daysAgo: 45),
                webUrl: devBaseURL),
        MiniApp(id: 6,
                name: "강의실 예약", description: "빈 강의실 조회 및 예약. 팀 프로젝트 공간을 손쉽게 확보",
                publisher: "총학생회", category: "ETC",
                iconUrl: nil, iconEmoji: "🏫", iconColorHex: "5B7FFF",
                rating: 4.1, ratingCount: 97,
                isNew: true, isPopular: false, createdAt: date(daysAgo: 3),
                webUrl: devBaseURL),
        MiniApp(id: 7,
                name: "캠퍼스 중고거래", description: "교내 중고 물품 거래. 같은 캠퍼스라 직거래가 편해요",
                publisher: "dev.박준혁", category: "MARKET",
                iconUrl: nil, iconEmoji: "🛒", iconColorHex: "22C993",
                rating: 4.4, ratingCount: 213,
                isNew: false, isPopular: true, createdAt: date(daysAgo: 60),
                webUrl: devBaseURL),
        MiniApp(id: 8,
                name: "단국 소개팅", description: "단국대 재학생 인증 기반 소개팅 매칭. 안전한 만남",
                publisher: "dev.최유진", category: "SOCIAL",
                iconUrl: nil, iconEmoji: "💘", iconColorHex: "FF6090",
                rating: 4.2, ratingCount: 445,
                isNew: false, isPopular: true, createdAt: date(daysAgo: 90),
                webUrl: devBaseURL),
        MiniApp(id: 9,
                name: "동아리 박람회", description: "전체 동아리 소개 및 가입 신청. 활동 후기와 일정 확인",
                publisher: "총학생회", category: "ETC",
                iconUrl: nil, iconEmoji: "🎯", iconColorHex: "36D1C4",
